...
import styles from './SequenceNodeHeader.module.scss';
import {
...
interface TSequenceNodeHeaderProps {
  className?: string;
  id?: number | string;
  prefix?: TReactNode;
  title?: TReactNode;
...
export const SequenceNodeHeader: React.FC<TSequenceNodeHeaderProps> = (props) => {
  const {
    // prettier-ignore
    id,
    className,
